...
module.exports = function execute(app, instructions, callback, cbAfterSetupDataSources) {
  ...
  if (cbAfterSetupDataSources) {
    cbAfterSetupDataSources(instructions, () => {
      afterSetupDataSources(app, instructions, callback);
    });
  } else {
    afterSetupDataSources(app, instructions, callback);
  }
...
function afterSetupDataSources(app, instructions, callback) {
