...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__globals__ = __webpack_require__(138);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AppDescriptionService; });
...
var AppDescriptionService = (function () {
    function AppDescriptionService() {
        this._jwtTokenKeyName = 'Amino_2_jwtTokenKeyName';
        this._userInfoKeyName = 'Amino_2_userInfoKeyName';
    }
    Object.defineProperty(AppDescriptionService.prototype, "jwtTokenKeyName", {
        get: function () {
    ...
    Object.defineProperty(AppDescriptionService.prototype, "userInfoKeyName", {
        get: function () {
    ...
    Object.defineProperty(AppDescriptionService.prototype, "appName", {
        get: function () {
            return __WEBPACK_IMPORTED_MODULE_1__globals__["c" /* APPLICATION_NAME */];
        },
        enumerable: true,
        configurable: true
    });
...
AppDescriptionService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [])
], AppDescriptionService);

//# sourceMappingURL=app-description.service.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return APPLICATION_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return PublishTarget; });
var ENV = 'development';
var APPLICATION_NAME = 'Merlin Gateway';
var PublishTarget;
(function (PublishTarget) {
    PublishTarget[PublishTarget["server"] = 1] = "server";
    PublishTarget[PublishTarget["local"] = 2] = "local";
    PublishTarget[PublishTarget["serverAndLocal"] = 3] = "serverAndLocal";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme_configProvider__ = __webpack_require__(160);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__theme_constants__ = __webpack_require__(245);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__guards_index__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__websocket_service__ = __webpack_require__(243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__globals__ = __webpack_require__(138);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PostalService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var postal = __webpack_require__(510);
var PostalService = (function () {
    function PostalService(http, webSocketService) {
        this.http = http;
        this.webSocketService = webSocketService;
        this.init();
    }
    PostalService.prototype.init = function () {
        var _this = this;
        var observable = this.http.get('/util/get-websocket-port', { headers: __WEBPACK_IMPORTED_MODULE_2__guards_index__["a" /* contentHeaders */] })
            .map(function (response) {
            return response.json();
        })
            .catch(this.handleError);
        observable.subscribe(function (webSocketInfo) {
            _this.messages = _this.webSocketService
            ...
            console.log(_this.getErrorText(err));
        });
    };
    PostalService.prototype.publish = function (channel, topic, data, publishTarget) {
        if (publishTarget === void 0) { publishTarget = __WEBPACK_IMPORTED_MODULE_5__globals__["b" /* PublishTarget */].serverAndLocal; }
        if (!this.messages) {
            alert('No Messages');
            return;
        }
        var envelope = { channel: channel, topic: topic, data: data };
        if (publishTarget === __WEBPACK_IMPORTED_MODULE_5__globals__["b" /* PublishTarget */].serverAndLocal || publishTarget === __WEBPACK_IMPORTED_MODULE_5__globals__["b" /* PublishTarget */].server) {
            this.messages.next(envelope);
        }
        if (publishTarget === __WEBPACK_IMPORTED_MODULE_5__globals__["b" /* PublishTarget */].serverAndLocal || publishTarget === __WEBPACK_IMPORTED_MODULE_5__globals__["b" /* PublishTarget */].local) {
            postal.publish(envelope);
        }
    };
    PostalService.prototype.subscribe = function (channel, topic, cb) {
        var _this = this;
        if (!this.messages) {
            setTimeout(function () {
                _this.subscribe(channel, topic, cb);
            }, 1000);
            return;
        }
        //Subscribe to WebSocket
        this.messages.subscribe(function (postalMessage) {
    ...
    PostalService.prototype.handleError = function (err) {
        return __WEBPACK_IMPORTED_MODULE_3_rxjs__["Observable"].throw(this.getErrorText(err));
    };
    PostalService.prototype.getErrorText = function (error) {
        return (error.message) ? error.message : error.status ? error.status + " - " + error.statusText : 'Server error';
    };
    return PostalService;
}());
PostalService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__websocket_service__["a" /* WebSocketService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__websocket_service__["a" /* WebSocketService */]) === "function" && _b || Object])
], PostalService);

var _a, _b;
//# sourceMappingURL=postal.service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_uploader__ = __webpack_require__(181);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_translation_module__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__theme_config__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__theme_configProvider__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components__ = __webpack_require__(394);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_baCard_baCardBlur_directive__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__directives__ = __webpack_require__(401);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pipes__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__validators__ = __webpack_require__(340);
...
NgaModule = NgaModule_1 = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4_ngx_uploader__["NgUploaderModule"]
        ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_description_service__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_authentication_models__ = __webpack_require__(339);
...
var AuthenticationService = (function () {
    function AuthenticationService(http, appDescriptionService) {
        this.http = http;
        this.appDescriptionService = appDescriptionService;
    }
    Object.defineProperty(AuthenticationService.prototype, "userInfo", {
        get: function () {
            var userInfoJson = localStorage.getItem(this.appDescriptionService.userInfoKeyName);
            return new __WEBPACK_IMPORTED_MODULE_6__models_authentication_models__["b" /* UserInfoImpl */](userInfoJson);
        },
        enumerable: true,
        configurable: true
    });
    AuthenticationService.prototype.updateUserInfo = function (userInfo) {
    ...
    AuthenticationService.prototype.login = function (loginFormSubmission) {
        return this.httpPost(loginFormSubmission, '/auth/login');
    };
    Object.defineProperty(AuthenticationService.prototype, "updateUserInfoResponse", {
        set: function (updateUserInfoResponse) {
    ...
    Object.defineProperty(AuthenticationService.prototype, "loginResponse", {
        set: function (loginResponse) {
            var ads = this.appDescriptionService;
    ...
    AuthenticationService.prototype.httpPost = function (postInfo, route) {
        var body = JSON.stringify(postInfo);
        return this.http.post(route, body, { headers: __WEBPACK_IMPORTED_MODULE_2__guards_index__["a" /* contentHeaders */] })
    ...
    AuthenticationService.prototype.checkResponse = function (res) {
        return res.json();
    };
    AuthenticationService.prototype.handleError = function (error) {
        var errorText = (error.message) ? error.message :
            error.status ? error.status + " - " + error.statusText : 'Server error';
        return __WEBPACK_IMPORTED_MODULE_4_rxjs__["Observable"].throw(errorText);
    };
    return AuthenticationService;
}());
AuthenticationService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__app_description_service__["a" /* AppDescriptionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__app_description_service__["a" /* AppDescriptionService */]) === "function" && _b || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_http_loader__ = __webpack_require__(421);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_jwt__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_jwt___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_angular2_jwt__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_description_service__ = __webpack_require__(137);
...
var AuthGuard = (function () {
    function AuthGuard(router, appDescriptionService) {
        this.router = router;
        this.appDescriptionService = appDescriptionService;
    }
    AuthGuard.prototype.canActivate = function () {
        try {
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_angular2_jwt__["tokenNotExpired"])(this.appDescriptionService.jwtTokenKeyName)) {
                return true;
            }
        }
        catch (err) {
...
AuthGuard = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_app_description_service__["a" /* AppDescriptionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_app_description_service__["a" /* AppDescriptionService */]) === "function" && _b || Object])
], AuthGuard);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__headers__ = __webpack_require__(351);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__ = __webpack_require__(182);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme__ = __webpack_require__(28);
...
var Pages = (function () {
    ...
    Pages.prototype.ngOnInit = function () {
        var children = __WEBPACK_IMPORTED_MODULE_2__pages_menu__["a" /* PAGES_MENU */][0].children;
        __WEBPACK_IMPORTED_MODULE_2__pages_menu__["a" /* PAGES_MENU */][0].children = children.sort(function (a, b) {
            return (a.data.menu.title).localeCompare(b.data.menu.title);
        });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme_constants__ = __webpack_require__(245);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__theme_configProvider__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__theme_config__ = __webpack_require__(159);
...
var map = {
	...
	"./newman/newman.module": [
		800,
		5
	],
	"./plugin-uploader/plugin-uploader.module": [
		801,
		3
	],
	"./plugins/mosaic/mosaic.module": [
		802,
		4
	],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return UserInfoImpl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserRegistrationInfo; });
...
var UserInfoImpl = (function () {
    function UserInfoImpl(json) {
        this.json = json;
...
var UserRegistrationInfo = (function (_super) {
    __extends(UserRegistrationInfo, _super);
    function UserRegistrationInfo(rfs) {
        ...
        _this.password = rfs.passwords.password;
        return _this;
    }
    return UserRegistrationInfo;
}(UserInfoImpl));

//# sourceMappingURL=authentication.models.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__email_validator__ = __webpack_require__(417);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__equalPasswords_validator__ = __webpack_require__(418);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_state__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__theme_services__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__theme_theme_config__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_postal_service__ = __webpack_require__(191);
...
var AppComponent = (function () {
    function AppComponent(_state, _imageLoader, _spinner, postalService, 
        ...
        this.postalService.subscribe('System', 'RefreshPage', function () {
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2__theme_services__["c" /* BaThemePreloader */].load().then(function () {
            _this._spinner.hide();
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ng_bootstrap_ng_bootstrap__ = __webpack_require__(346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_routing__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_component__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_service__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__global_state__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__theme_nga_module__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_pages_module__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_postal_service__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_websocket_service__ = __webpack_require__(243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_app_description_service__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_alert_service__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_authentication_service__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__environment__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ng2_modules_auth_module__ = __webpack_require__(420);
...
var APP_PROVIDERS = [
    ...
    __WEBPACK_IMPORTED_MODULE_14__services_app_description_service__["a" /* AppDescriptionService */],
    __WEBPACK_IMPORTED_MODULE_15__services_alert_service__["a" /* AlertService */],
    __WEBPACK_IMPORTED_MODULE_12__services_postal_service__["a" /* PostalService */],
...
var LOCAL_AUTH_PROVIDERS = [
    ...
    __WEBPACK_IMPORTED_MODULE_19__ng2_modules_auth_module__["a" /* AuthModule */]
];
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_18__environment__["a" /* ENV_PROVIDERS */],
            APP_PROVIDERS,
...
if ('production' === __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* ENV */] || 'renderer' === __WEBPACK_IMPORTED_MODULE_2__globals__["a" /* ENV */]) {
    // Production
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["b" /* disableDebugTools */])();
    ...
    _decorateModuleRef = function (modRef) {
        ...
        var _ng = window.ng;
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["c" /* enableDebugTools */])(cmpRef);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_translation_module__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_component__ = __webpack_require__(244);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_component__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__guards_auth_guard__ = __webpack_require__(241);
/* unused harmony export routes */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return routing; });
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'plugin-uploader', loadChildren: './plugin-uploader/plugin-uploader.module#PluginUploaderModule' },
            { path: 'newman', loadChildren: './newman/newman.module#NewmanModule' },
            { path: 'mosaic', loadChildren: './plugins/mosaic/mosaic.module#MosaicModule' }
        ],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme_services__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_amcharts3__ = __webpack_require__(423);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_amcharts3_amcharts_plugins_responsive_responsive_js__ = __webpack_require__(424);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_amcharts3_amcharts_serial_js__ = __webpack_require__(425);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ammap3__ = __webpack_require__(426);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ammap3_ammap_maps_js_worldLow__ = __webpack_require__(427);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__baAmChartTheme_service__ = __webpack_require__(361);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baAmChart_component__ = __webpack_require__(360);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baBackTop_component__ = __webpack_require__(363);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__baCardBlurHelper_service__ = __webpack_require__(367);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baCard_component__ = __webpack_require__(365);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chartist__ = __webpack_require__(428);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baChartistChart_component__ = __webpack_require__(369);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baCheckbox_component__ = __webpack_require__(371);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baContentTop_component__ = __webpack_require__(373);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ngx_uploader__ = __webpack_require__(181);
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ngx_uploader__["NgUploaderOptions"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ngx_uploader__["NgUploaderOptions"]) === "function" && _a || Object)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baFileUploader_component__ = __webpack_require__(375);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baFullCalendar_component__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global_state__ = __webpack_require__(52);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baMenuItem_component__ = __webpack_require__(380);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baMenu_component__ = __webpack_require__(379);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baMsgCenter_service__ = __webpack_require__(384);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baMsgCenter_component__ = __webpack_require__(383);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baMultiCheckbox_component__ = __webpack_require__(386);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_state__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_authentication_service__ = __webpack_require__(193);
...
var BaPageTop = (function () {
    function BaPageTop(authenticationService, _state) {
        var _this = this;
    ...
    Object.defineProperty(BaPageTop.prototype, "username", {
        get: function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baPageTop_component__ = __webpack_require__(388);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baPictureUploader_component__ = __webpack_require__(390);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_state__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__theme__ = __webpack_require__(28);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baSidebar_component__ = __webpack_require__(392);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baPageTop__ = __webpack_require__(389);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baMsgCenter__ = __webpack_require__(385);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__baSidebar__ = __webpack_require__(393);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__baMenu_components_baMenuItem__ = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__baMenu__ = __webpack_require__(382);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__baContentTop__ = __webpack_require__(374);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__baCard__ = __webpack_require__(368);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__baAmChart__ = __webpack_require__(362);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__baChartistChart__ = __webpack_require__(370);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__baBackTop__ = __webpack_require__(364);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__baFullCalendar__ = __webpack_require__(378);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__baPictureUploader__ = __webpack_require__(391);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__baCheckbox__ = __webpack_require__(372);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__baMultiCheckbox__ = __webpack_require__(387);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__baFileUploader__ = __webpack_require__(376);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baScrollPosition_directive__ = __webpack_require__(395);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_slimscroll__ = __webpack_require__(509);
...
var BaSlimScroll = (function () {
    ...
    BaSlimScroll.prototype._init = function () {
        ...
        /*    const nativeElement = jQuery(this._elementRef.nativeElement);
            try {
              const slimScroll = nativeElement.slimScroll;
    ...
    BaSlimScroll.prototype._destroy = function () {
        ...
        /*    const nativeElement = jQuery(this._elementRef.nativeElement);
            try {
              nativeElement.slimScroll({destroy: true});
            } catch (ex) {
              // eat it
              console.log(ex);
            }*/
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baSlimScroll_directive__ = __webpack_require__(397);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baThemeRun_directive__ = __webpack_require__(399);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baScrollPosition__ = __webpack_require__(396);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baThemeRun__ = __webpack_require__(400);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__baSlimScroll__ = __webpack_require__(398);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baAppPicture_pipe__ = __webpack_require__(402);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baKameleonPicture_pipe__ = __webpack_require__(404);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baProfilePicture_pipe__ = __webpack_require__(406);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baProfilePicture__ = __webpack_require__(407);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baAppPicture__ = __webpack_require__(403);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__baKameleonPicture__ = __webpack_require__(405);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baImageLoader_service__ = __webpack_require__(409);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__ = __webpack_require__(91);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baMenu_service__ = __webpack_require__(411);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baThemePreloader_service__ = __webpack_require__(413);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baThemeSpinner_service__ = __webpack_require__(415);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baImageLoader__ = __webpack_require__(410);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baMenu__ = __webpack_require__(412);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__baThemePreloader__ = __webpack_require__(414);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__baThemeSpinner__ = __webpack_require__(416);
