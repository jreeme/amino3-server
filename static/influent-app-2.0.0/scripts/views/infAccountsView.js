...
//					annotationIcon : 'glyphicon glyphicon-plus',
    ...
    var _registerView = function (sandbox) {
      infView.registerView({
        ...
        queryParams: function () {
          return {query: _UIObjectState.currentSearchString};
        }
      }, sandbox);
    };
    ...
    var _onDatasetStats = function (eventChannel, data) {
      ...
      if (data.endDate === '2015-07-0') {
        data.endDate = '2015-07-1';
      }
    ...
    modules.register('inf' + VIEW_NAME + 'View', function (sandbox) {
      return {
        start: function () {
          var subTokens = {};
          subTokens[appChannel.ALL_MODULES_STARTED] = aperture.pubsub.subscribe(appChannel.ALL_MODULES_STARTED, function () {
            _init(sandbox);
          });
